...
until /opt/mssql-tools18/bin/sqlcmd -S "${mssqlconn[Database]}.${mssqlconn[Server]}" -G -C -I -i /app/sql/FiatDbMigrationScript.sql -o /app/sql/FiatDbMigrationScriptOutput.txt
do
